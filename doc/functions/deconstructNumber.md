...
> **deconstructNumber**(`input`: `number`, `precision`: `number`): [`DeconstructedNumber`](../type-aliases/DeconstructedNumber.md) & \{ `fraction`: [`DeconstructedNumber`](../type-aliases/DeconstructedNumber.md); `whole`: [`DeconstructedNumber`](../type-aliases/DeconstructedNumber.md); \}
...
[`DeconstructedNumber`](../type-aliases/DeconstructedNumber.md) & \{ `fraction`: [`DeconstructedNumber`](../type-aliases/DeconstructedNumber.md); `whole`: [`DeconstructedNumber`](../type-aliases/DeconstructedNumber.md); \}
