// // extracted from 'romanization' npm package, tested against the reference data

// import { empty, quote } from '@technobuddha/library';

// import { romanization } from '../../src/esnext/@data/romanization.ts';
...
//   const r = romanization[chars[i].codePointAt(0)!];
//   if (r !== charsLatin[i]) {
//     console.log(quote(chars[i]), quote(charsLatin[i]), quote(r ?? empty));
//   }
// }
