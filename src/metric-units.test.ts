...
//TODO [2021-09-30] add tests for 'pad' option, add tests for R & Q
describe('metricUnits', () => {
  ...
  test('should handle macro', () => {
    ...
    expect(metricUnits(1000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] })).toBe(
      '1D',
    );
    expect(metricUnits(1000000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] })).toBe(
      '1E',
    );
    expect(
      metricUnits(1000000000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1F');
    expect(
      metricUnits(1000000000000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1G');
    expect(
      metricUnits(1000000000000000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1H');
  });
  ...
  test('should handle micro', () => {
    ...
    expect(metricUnits(0.000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] })).toBe(
      '1C',
    );
    expect(metricUnits(0.000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] })).toBe(
      '1D',
    );
    expect(
      metricUnits(0.000000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1E');
    expect(
      metricUnits(0.000000000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1F');
    expect(
      metricUnits(0.000000000000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1G');
    expect(
      metricUnits(0.000000000000000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] }),
    ).toBe('1H');
  });
