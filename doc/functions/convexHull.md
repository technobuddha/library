...
> **convexHull**(`vertices`: [`Polygon`](../type-aliases/Polygon.md)): `undefined` \| [`Polygon`](../type-aliases/Polygon.md)
...
| ------ | ------ | ------ |
| `vertices` | [`Polygon`](../type-aliases/Polygon.md) | An array of points representing the polygon vertices. Each point should have `x` and `y` properties. |

## Returns

`undefined` \| [`Polygon`](../type-aliases/Polygon.md)
