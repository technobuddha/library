...
const post = /\s*$/v;
const sep = /(?:\s*[\/.\-]?\s*)/v;
const mm = /([0][1-9]|[1][012])/v;
const mmm =
  /(jan|january|feb|february|mar|march|apr|april|may|jun|june|jul|july|aug|august|sep|sept|september|oct|october|nov|november|dec|december)/v;
const dd = /([0][1-9]|[12][0-9]|[3][01])/v;
const yyyy = /(\d{4})/v;
const time =
