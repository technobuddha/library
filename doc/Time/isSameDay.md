...
> **isSameDay**(`input1`: [`Date`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date), `input2`: [`Date`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date), `__namedParameters`: [`IsSameDayOptions`](IsSameDayOptions.md)): `boolean`
...
| `__namedParameters` | [`IsSameDayOptions`](IsSameDayOptions.md) | see [IsSameDayOptions](IsSameDayOptions.md) |
