...
import { isOct, u4, u8, x2 } from './helpers.ts';
/**
 ...
 *
 * // With ascii option
 * escapePython('café');         // "café"
 * escapePython('café', { ascii: true }); // "caf\\u00e9"
 * escapePython('😀', { ascii: true });   // "\\U0001f600"
 * ```
 * @group Escape
 * @category Python
 */
export function escapePython(input: StringLike, { ascii = false }: EscapeOptions = {}): string {
