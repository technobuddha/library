...
describe(
    ...
    () => {
        ...
        it(
            ...
            () => {
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.sunday    })).to.equal(4);
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.monday    })).to.equal(3);
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.tuesday   })).to.equal(2);
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.wednesday })).to.equal(1);
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.thursday  })).to.equal(7);
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.friday    })).to.equal(6);
                expect(getDayOfWeek(new Date('4 Jul 2018'), { startOfWeek: day.saturday  })).to.equal(5);
            }
        );
        ...
        it(
            ...
            () => {
                expect(getDayOfWeek(new Date(Date.UTC(2018, 6, 4)), { UTC: true })).to.equal(2);
            }
        );
