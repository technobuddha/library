...
describe('getBeginningOfWeek', () => {
  test('should find the beginning of the week', () => {
    expect(getBeginningOfWeek(new Date('20 Jul 1969 20:18')).toString()).toBe(
  ...
  test('should accept alternate start of week', () => {
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 0 }).toString(),
    ).toBe(new Date('20 Jul 1969').toString());
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 1 }).toString(),
    ).toBe(new Date('14 Jul 1969').toString());
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 2 }).toString(),
    ).toBe(new Date('15 Jul 1969').toString());
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 3 }).toString(),
    ).toBe(new Date('16 Jul 1969').toString());
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 4 }).toString(),
    ).toBe(new Date('17 Jul 1969').toString());
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 5 }).toString(),
    ).toBe(new Date('18 Jul 1969').toString());
    expect(
      getBeginningOfWeek(new Date('20 Jul 1969 20:18'), { firstDayOfWeek: 6 }).toString(),
