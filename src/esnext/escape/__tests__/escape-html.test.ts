...
describe('escapeHTML', () => {
  ...
  test('should escape Latin-1, BMP or astral when ascii is set', () => {
    expect(escapeHTML('¡¢£ýþÿ', { ascii: true })).toBe('&#161;&#162;&#163;&#253;&#254;&#255;');
    expect(escapeHTML('ΑΒΓΔΕΖ', { ascii: true })).toBe('&#913;&#914;&#915;&#916;&#917;&#918;');
    expect(escapeHTML('😀😁😂😺😸😹', { ascii: true })).toBe(
      '&#128512;&#128513;&#128514;&#128570;&#128568;&#128569;',
    );
  });
});
