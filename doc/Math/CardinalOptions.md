...
| <a id="shift"></a> `shift?` | [`Numbering`](Numbering.md)\[`"shift"`\] | `undefined` | - | [numbering/cardinal.ts:55](https://github.com/technobuddha/library/blob/main/src/numbering/cardinal.ts#L55) |
