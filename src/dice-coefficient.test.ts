...
describe('diceCoefficient', () => {
  ...
  test('Accept case insensitive option', () => {
    expect(
      diceCoefficient('Drink Coca Cola', 'DRINK PEPSI COLA', { caseInsensitive: true }),
    ).toBeCloseTo(0.6206896551724138);
