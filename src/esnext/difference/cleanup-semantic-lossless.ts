...
import { type Difference, DIFFERENCE_EQUAL } from './difference.ts';

const nonAlphaNumericRegex = /[^a-zA-Z\d]/v;
const whitespaceRegex = /\s/v;
 ...
 */
export function cleanupSemanticLossless(diffs: Difference[]): void {
  /**
