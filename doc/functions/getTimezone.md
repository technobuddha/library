...
> **getTimezone**(`input`: `number` \| [`Date`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date), `__namedParameters`: [`GetTimezoneOptions`](../type-aliases/GetTimezoneOptions.md)): `string`
...
| `__namedParameters` | [`GetTimezoneOptions`](../type-aliases/GetTimezoneOptions.md) | see [GetTimezoneOptions](../type-aliases/GetTimezoneOptions.md) |
