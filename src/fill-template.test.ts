...
describe('fillTemplate', () => {
  test('should handle templates', () => {
    expect(fillTemplate('A sunny {{day}} in {{month}}.', { day: 'Monday', month: 'June' })).toBe(
  ...
  test('should allow different delimiters', () => {
    ...
    ).toBe('The Statue of Liberty.');
  });

  test('should not modify strings without delimiters', () => {
    expect(fillTemplate('A cat and a dog.', {})).toBe('A cat and a dog.');
  });

  test('should remove delimiters without value', () => {
