...
| <a id="shift"></a> `shift?` | [`Numbering`](Numbering.md)\[`"shift"`\] | `undefined` | - | [numbering/ordinal.ts:56](https://github.com/technobuddha/library/blob/main/src/numbering/ordinal.ts#L56) |
