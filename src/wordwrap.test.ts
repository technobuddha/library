...
describe('wordwrap', () => {
  ...
  test('wrap specify line separator', () => {
    expect(
      wordwrap(
        "If you set your goals ridiculously high and it's a failure, you will fail above everyone else's success.",
        { separator: '|' },
  ...
  test('turn off word boundaries & add trailing spaces', () => {
    expect(
      wordwrap(
        "If you set your goals ridiculously high and it's a failure, you will fail above everyone else's success.",
