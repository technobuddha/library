...
//TODO [2025-01-01]: add tests for 'pad' option
describe('metricUnits', () => {
  test('should handle numbers greater than 1', () => {
    ...
    expect(metricUnits(1000000000000000000000000000)).toBe('1R');
    expect(metricUnits(1000000000000000000000000000000)).toBe('1Q');
  });
  ...
  test('should handle numbers less than 1', () => {
    ...
    expect(metricUnits(0.000000000000000000000000001)).toBe('1r');
    expect(metricUnits(0.000000000000000000000000000001)).toBe('1q');
  });
  ...
  test('should handle macro', () => {
    expect(metricUnits(1, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe('1');
    expect(metricUnits(10, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe(
      '10',
    );
    expect(metricUnits(100, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe(
      '100',
    );
    expect(metricUnits(1000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe(
      '1A',
    );
    expect(
      metricUnits(1000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1B');
    expect(
      metricUnits(1000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1C');
    expect(
      metricUnits(1000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1D');
    expect(
      metricUnits(1000000000000000, { macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1E');
    expect(
      metricUnits(1000000000000000000, {
        macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1F');
    expect(
      metricUnits(1000000000000000000000, {
        macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1G');
    expect(
      metricUnits(1000000000000000000000000, {
        macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1H');
    expect(
      metricUnits(1000000000000000000000000000, {
        macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1I');
    expect(
      metricUnits(1000000000000000000000000000000, {
        macro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1J');
  });

  test('should handle micro', () => {
    expect(metricUnits(0.1, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe(
      '100A',
    );
    expect(metricUnits(0.01, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe(
      '10A',
    );
    expect(metricUnits(0.001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] })).toBe(
      '1A',
    );
    expect(
      metricUnits(0.000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1B');
    expect(
      metricUnits(0.000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1C');
    expect(
      metricUnits(0.000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1D');
    expect(
      metricUnits(0.000000000000001, { micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'] }),
    ).toBe('1E');
    expect(
      metricUnits(0.000000000000000001, {
        micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1F');
    expect(
      metricUnits(0.000000000000000000001, {
        micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1G');
    expect(
      metricUnits(0.000000000000000000000001, {
        micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1H');
    expect(
      metricUnits(0.000000000000000000000000001, {
        micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1I');
    expect(
      metricUnits(0.000000000000000000000000000001, {
        micro: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'],
      }),
    ).toBe('1J');
  });

  test('should handle unit', () => {
