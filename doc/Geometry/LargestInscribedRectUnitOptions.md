[@technobuddha/library](../modules.md) / LargestInscribedRectUnitOptions
...
Defined in: [src/largest-inscribed-rectangle.ts:29](https://github.com/technobuddha/library/blob/main/src/largest-inscribed-rectangle.ts#L29)
