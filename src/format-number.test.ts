...
describe('formatNumber', () => {
  ...
  test('should support the D (Decimal) format', () => {
  ...
  test('should support the E (Exponential) format', () => {
  ...
  test('should support the F (Fixed) format', () => {
  ...
  test('should support the G (General) format', () => {
    expect(formatNumber(-123.456, 'G')).toBe('-123.456');
    expect(formatNumber(123.4546, 'G4')).toBe('123.5');
    expect(formatNumber(-1.23456789e-25, 'G')).toBe('-1.23456789E-25');
    expect(formatNumber(-1.23456789e-25, 'g')).toBe('-1.23456789e-25');
  ...
  test('should support the N (Number) format', () => {
  ...
  test('should support the P (Percent) format', () => {
  ...
  test('should support the R (Round-trip) format', () => {
  ...
  test('should support the X (Hexadecimal) format', () => {
  ...
  test('should support the Zero placeholder', () => {
    ...
    expect(formatNumber(1234.56789, '0,0.00')).toBe('1,234.57');
  });

  test('should support the Digit placeholder', () => {
  ...
  test('should support the Decimal Point', () => {
    expect(formatNumber(0.45678, '0.00')).toBe('0.46');
    expect(formatNumber(1.2, '0.00')).toBe('1.20');
    expect(formatNumber(1.2, '00.00')).toBe('01.20');
  ...
  test('should support the Group Separator', () => {
  ...
  test('should support the Percentage Placeholder', () => {
  ...
  test('should support the Escape Character', () => {
    expect(formatNumber(987654, '\\###00\\#')).toBe('#987654#');
    expect(formatNumber(123, '\\#\\#\\# ##0 dollars and \\0\\0 cents \\#\\#\\#')).toBe(
      '### 123 dollars and 00 cents ###',
    );
    expect(formatNumber(123, '\\\\\\\\\\\\ ##0 dollars and \\0\\0 cents \\\\\\\\\\\\')).toBe(
      '\\\\\\ 123 dollars and 00 cents \\\\\\',
    );
  ...
  test("should support the Literal String (') delimiter", () => {
  ...
  test('should support the Section separator', () => {
  ...
  test('should support the Other characters', () => {
  ...
  test('should support big numbers', () => {
