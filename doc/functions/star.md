...
> **star**(`sides`: `number`, `outer`: `number`, `inner`: `number`, `origin`: [`Cartesian`](../type-aliases/Cartesian.md)): [`Polygon`](../type-aliases/Polygon.md)
...
| `origin` | [`Cartesian`](../type-aliases/Cartesian.md) | `...` | The center point of the star, as a Cartesian coordinate. Defaults to `{ x: 0, y: 0 }`. |
