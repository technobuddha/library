[@technobuddha/library](../modules.md) / ISOWeeksInYearOptions
...
Defined in: [src/iso-weeks-in-year.ts:11](https://github.com/technobuddha/library/blob/main/src/iso-weeks-in-year.ts#L11)
