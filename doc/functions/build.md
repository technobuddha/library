...
> **build**(...`args`: ([`Stringy`](../type-aliases/Stringy.md) \| [`Generator`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Generator)\<[`Stringy`](../type-aliases/Stringy.md), `any`, `any`\> \| `IterableIterator`\<`string`, `any`, `any`\> \| () => [`Stringy`](../type-aliases/Stringy.md))[]): `string`
