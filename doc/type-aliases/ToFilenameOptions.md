...
| ------ | ------ | ------ | ------ |
| <a id="disambiguate"></a> `disambiguate`? | `number` | number of characters to presere at the end of the filename when truncated (for disambiguation) | [to-filename.ts:19](https://github.com/technobuddha/library/blob/main/src/to-filename.ts#L19) |
