[@technobuddha/library](../modules.md) / RelativeTimeOptions
...
Defined in: [src/relative-time.ts:14](https://github.com/technobuddha/library/blob/main/src/relative-time.ts#L14)
