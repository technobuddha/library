...
import { nbsp, zwsp } from '../unicode/unicode.ts';
 ...
 * @category HTML
 */
export function unescapeHTML(input: StringLike): string {
  return toString(input).replaceAll(/&((#[0-9]+)|(#x[0-9a-f]+)|([a-z][a-z0-9]+));/giv, (entity) => {
