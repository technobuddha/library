...
> **area**(`vertices`: [`Polygon`](../type-aliases/Polygon.md), `signed`: `boolean`): `number`
...
| ------ | ------ | ------ | ------ |
| `vertices` | [`Polygon`](../type-aliases/Polygon.md) | `undefined` | An array of points representing the polygon's vertices, where each point has `x` and `y` properties. |
