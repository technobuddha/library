...
describe('Sha512', () => {
  ...
  test('binary encoding', () => {
    expect(new Sha512().update('x').digest('binary')).toBe(
      '\u{A4}\u{AB}\u{D4}\u{44}\u{8C}\u{49}\u{56}\u{2D}\u{82}\u{81}\u{15}\u{D1}\u{3A}\u{1F}\u{CC}\u{EA}\u{92}\u{7F}\u{52}\u{B4}\u{D5}\u{45}\u{92}\u{97}\u{F8}\u{B4}\u{3E}\u{42}\u{DA}\u{89}\u{23}\u{8B}\u{C1}\u{36}\u{26}\u{E4}\u{3D}\u{CB}\u{38}\u{DD}\u{B0}\u{82}\u{48}\u{89}\u{27}\u{EC}\u{90}\u{4F}\u{B4}\u{20}\u{57}\u{44}\u{39}\u{83}\u{E8}\u{85}\u{85}\u{17}\u{9D}\u{50}\u{55}\u{1A}\u{FE}\u{62}',
    );
  });
