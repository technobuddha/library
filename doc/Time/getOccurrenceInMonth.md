...
> **getOccurrenceInMonth**(`input`: [`Date`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date), `dayOfWeek`: [`DayOfWeek`](DayOfWeek.md), `occurrence`: `number` \| `"last"`, `options`: [`GetOccurrenceInMonthOptions`](GetOccurrenceInMonthOptions.md)): `null` \| [`Date`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date)

Defined in: [get-occurrence-in-month.ts:31](https://github.com/technobuddha/library/blob/main/src/get-occurrence-in-month.ts#L31)
