...
> **angleReflection**(`angle`: `number`, `axis`: `number`, `units`: [`AngleUnit`](../type-aliases/AngleUnit.md)): `number`
...
| `units` | [`AngleUnit`](../type-aliases/AngleUnit.md) | `'radians'` | The unit of the angles ('radians' by default). |
