...
> **isWithLine**(`point`: [`Cartesian`](../type-aliases/Cartesian.md), `line`: [`LineSegment`](../type-aliases/LineSegment.md), `epsilon`: `number`): `boolean`
...
| ------ | ------ | ------ | ------ |
| `point` | [`Cartesian`](../type-aliases/Cartesian.md) | `undefined` | The Cartesian coordinates of the point to test. |
