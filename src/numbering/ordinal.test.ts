...
describe('ordinal', () => {
  describe('output = numeric', () => {
    ...
    test('should handle exponential number', () => {
      ...
      // TODO [2025-08-13]: We should be showing some sort of number...
      expect(ordinal(1e-100, o)).toBe('0th');
      expect(ordinal(1.2e-110, o)).toBe('0th');
      expect(ordinal(1.23e-120, o)).toBe('0th');
    });
