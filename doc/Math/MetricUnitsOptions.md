...
| ------ | ------ | ------ | ------ |
| <a id="format"></a> `format?` | `string` | format specification to pass to [formatNumber](formatNumber.md) | [metric-units.ts:56](https://github.com/technobuddha/library/blob/main/src/metric-units.ts#L56) |
