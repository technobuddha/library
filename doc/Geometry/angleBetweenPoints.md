[@technobuddha/library](../modules.md) / angleBetweenPoints
...
Defined in: [src/angle-between-points.ts:22](https://github.com/technobuddha/library/blob/main/src/angle-between-points.ts#L22)
